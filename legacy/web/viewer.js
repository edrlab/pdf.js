    ...
    const pageRenderedExtract = async ev => {
      try {
        if (ev.pageNumber === 1) {
          ...
          const doc = page === null || page === void 0 ? void 0 : (_page$annotationLayer = page.annotationLayerFactory) === null || _page$annotationLayer === void 0 ? void 0 : _page$annotationLayer.pdfDocument;
          const metadata = await doc.getMetadata();
          const numberofpages = doc === null || doc === void 0 ? void 0 : doc.numPages;
