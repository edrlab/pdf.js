...
gulp.task("metalsmith", async function () {
  return new Promise((resolve, reject) => {
    Metalsmith(__dirname)
      ...
      .metadata({
        sitename: "PDF.js",
        siteurl: "https://edrlab.github.io/pdf.js",
        description:
...
function packageJson() {
  ...
  const DIST_HOMEPAGE = "https://edrlab.github.io/pdf.js/";
  const DIST_BUGS_URL = "https://github.com/edrlab/pdf.js/issues";
  const DIST_GIT_URL = "https://github.com/edrlab/pdf.js.git";
