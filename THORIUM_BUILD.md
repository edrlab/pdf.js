...
* `git checkout --orphan v6.3.289_BUILD && git rm -r --cached . && git add build/gh-pages/build build/gh-pages/web build/types -f`
* `mv build build_ && git checkout v6.3.289_BUILD && rm -rf build && mv build_ build`
* Multiline:
```
